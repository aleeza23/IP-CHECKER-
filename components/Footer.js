...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
      ...
      {/* Copyright section */}
      <div className="w-full bg-green-600 text-white p-4 text-center">
        © 2024 IP Checker Powered by <Link className="underline" href={'https://thestockit.net/'}>The Stockit</Link>. All rights reserved!
      </div>
