    ...
    <blockquote className="flex flex-col items-center p-4">
      <div className='bg-green-500 px-16 py-24 rounded-lg text-white'>
        ...
        <p className="max-w-4xl text-xl font-thin text-center md:text-2xl lg:text-2xl">
          An IP address (Internet Protocol address) is a unique identifier assigned to each device connected to a network, whether it's the internet or a local network. It serves as a way for devices to communicate with each other and route data across the internet.
        </p>
      </div>
    </blockquote>
  );
